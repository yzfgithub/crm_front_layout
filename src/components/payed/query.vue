<template>
    <el-form :inline="true" :model="queryForm" class="demo-form-inline">
        ...
        <el-form-item label="付费时间">
            <el-date-picker v-model="queryForm.paidStartDate" type="date" value-format="yyyy/MM/dd" placeholder="选择开始时间" ref="start_date">
            </el-date-picker>
            &nbsp;&nbsp;
            <el-date-picker v-model="queryForm.paidEndDate" type="date" value-format="yyyy/MM/dd" placeholder="选择结束时间">
            </el-date-picker>
        </el-form-item>
