<template>
    <div class="container">
        <div class="f_head">
            ...
            <div v-if="!isMultipleSelect"> &nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;&nbsp; <img src="../../assets/quxiao_device.png" alt=""> <span class="click-span" @click="quxiaoDeviceClick">取消设备检测课</span></div>
