<template>
    <el-form :inline="true" :model="queryForm" class="demo-form-inline">
        ...
        <el-form-item label="订单状态">
            <el-select v-model="queryForm.status" placeholder="请选择订单状态">
                <el-option label="全部" value="" key=""></el-option>
                <el-option v-for="(val,key) in conversion_status" :label="val" :key="key" :value="val"></el-option>
            </el-select>
        </el-form-item>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        data() {
            return {
                conversion_status:meta.conversion_status,
            }
        },
        methods: {
            onSubmit() {
