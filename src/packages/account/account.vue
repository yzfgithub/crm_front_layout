...
<script>
    import NavMenu from '@/commons/menu/menu'
    export default {
        data(){
            return{
                                ...
                                childs:[
                                    {
                                        entity: {
                                            id: 311,
                                            name: "/account/shareManage/clue_rank",
                                            icon: "el-icon-loading",
                                            alias: "线索排名",
                                            count:'',
                                            value: { path: "/hello" }
                                    ...
                                    },
                                    {
                                        entity: {
                                            id: 312,
                                            name: "/account/shareManage/clue_assign",
                                            icon: "el-icon-loading",
                                            alias: "线索分配",
                                            count:'',
                                            value: { path: "/hello" }
                                    ...
                                    },
                                    {
                                        entity: {
                                            id: 313,
                                            name: "/account/shareManage/clue_schedule",
                                            icon: "el-icon-loading",
                                            alias: "销售排班",
                                            count:'',
                                            value: { path: "/hello" }
                                    ...
                                    },
                                    {
                                        entity: {
                                            id: 314,
                                            name: "/account/shareManage/clue_depositary",
                                            icon: "el-icon-loading",
                                            alias: "私池库容",
                                            count:'',
                                            value: { path: "/hello" }
