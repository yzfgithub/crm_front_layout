<template>
    <div>
        <div class="top">
            <div class="title">权限管理／权限列表</div>
            <query class="form" :queryForm = 'form' @onSubmit="load"></query>
        </div>
        <div class="bottom">
            <clueAForm :dataList="dataList" :meta="meta" @load="load"></clueAForm>
        </div>
    </div>

</template>
<script type="text/ecmascript-6">
    import query from '@/components/permissionsManage/query'
    import clueAForm from '@/components/permissionsManage/form'
