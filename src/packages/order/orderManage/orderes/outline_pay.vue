...
<script>
    import list from '@/components/orderManage/outline_pay_log_list'
    ...
    export default {
        ...
        methods:{
            load(){
                fetcher.pay_logs_list(this.$route.params.id,Object.assign({page:this.meta.current_page,pay_type:5}),(response) => {
