    ...
    <div>
        ...
        <div class="bottom">
            <el-tabs class="tab_box" v-model="activeName" @tab-click="handleClick">
                ...
                <el-tab-pane label="沟通记录(222)" name="second">
                    <secondCom :tabName="activeName"></secondCom>
                </el-tab-pane>
                <el-tab-pane label="课程记录(222)" name="third">
                    <thirdCom :show_edit="show_edit" :tabName="activeName"></thirdCom>
                </el-tab-pane>
                <el-tab-pane label="订单记录(222)" name="fourth">
                    <fourCom :show_edit="show_edit" :tabName="activeName"></fourCom>
                </el-tab-pane>
                <el-tab-pane label="赠课记录(222)" name="fifth">
                    <fiveCom :tabName="activeName"></fiveCom>
                </el-tab-pane>
                <!--<el-tab-pane label="电联语音（2）" name="sixth">-->
                    <!--<sixCom :tabName="activeName"></sixCom>-->
                <!--</el-tab-pane>-->
                <el-tab-pane label="操作日志(222)" name="seventh">
                    <sevenCom :tabName="activeName"></sevenCom>
                </el-tab-pane>
                <el-tab-pane label="来源记录(222)" name="eighth">
